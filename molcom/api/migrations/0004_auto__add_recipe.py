...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_recipe', (
            ('uuid', self.gf('django.db.models.fields.CharField')(default='e8d2de14-b912-4473-804b-74c248cf4946', max_length=36, primary_key=True)),
    ...
    models = {
        ...
        u'api.recipe': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0eecb815-688f-405e-ac84-b66eda0fbe9d'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'auth.group': {
