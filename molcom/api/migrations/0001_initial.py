...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_recipe', (
            ('id', self.gf('django.db.models.fields.CharField')(default='3a230739-3858-48dc-b968-51466b45f8f3', max_length=36, primary_key=True)),
        ...
        db.create_table(u'api_ipblock', (
            ...
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.CityLocation'], null=True)),
        ))
    ...
    models = {
        ...
        u'api.recipe': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'9354be45-e2ac-4611-8586-351c8c4a61c8'", 'max_length': '36', 'primary_key': 'True'}),
